...
import './CarbonOffsetsEscrowStorage.sol';
...
contract CarbonOffsetsEscrow is
    ICarbonOffsetsEscrow,
    OwnableUpgradeable,
    PausableUpgradeable,
    UUPSUpgradeable,
    AccessControlUpgradeable,
    CarbonOffsetsEscrowStorage
{
    ...
    modifier onlyTCO2() {
        require(
            IContractRegistry(contractRegistry).isValidERC20(msg.sender),
            'Not TCO2'
        );
        _;
    }
    ...
    function setContractRegistry(address _address) external onlyOwner {
        ...
        onlyTCO2
    {
        ...
        ICarbonOffsets(msg.sender).retireAndMintCertificateForEntity(
            request.user,
            params
        );
    }
        ...
        onlyTCO2
    {
        ...
        ICarbonOffsets(msg.sender).burnFrom(address(this), amount);
    }
    ...
    function getProjectVintageTokenId(address tco2)
        ...
        returns (uint256)
    {
        return ICarbonOffsets(tco2).projectVintageTokenId();
    }
