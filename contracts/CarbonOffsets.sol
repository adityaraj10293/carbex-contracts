...
import './bases/CarbonOffsetsDirectRetirements.sol';
import './bases/CarbonOffsetsWithBatchBase.sol';
...
/// @dev Each TCO2 contract is deployed via a Beacon Proxy in `CarbonOffsetsFactory`
contract CarbonOffsets is
    CarbonOffsetsWithBatchBase,
    CarbonOffsetsDirectRetirements
{
    // ----------------------------------------
    //      Constants
    // ----------------------------------------
