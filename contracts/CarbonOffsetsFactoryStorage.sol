...
/// @dev V1 Storage contract for CarbonOffsetsFactory v.1.0
abstract contract CarbonOffsetsFactoryStorageV1 {
    address public contractRegistry;
    address[] public deployedContracts;
    mapping(uint256 => address) public pvIdtoERC20;
}

/// @dev V2 Storage contract for CarbonOffsetsFactory v.1.1
abstract contract CarbonOffsetsFactoryStorageV2 {
...
/// @dev V3 Storage contract for CarbonOffsetsFactory v.1.2
abstract contract CarbonOffsetsFactoryStorageV3 {
...
abstract contract CarbonOffsetsFactoryStorage is
    CarbonOffsetsFactoryStorageV2,
    CarbonOffsetsFactoryStorageV3
{
