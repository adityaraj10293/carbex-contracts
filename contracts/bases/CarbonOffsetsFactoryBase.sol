...
import '../CarbonOffsetsFactoryStorage.sol';

/// @notice This TCO2 factory base should be used for any logic specific implementation
abstract contract CarbonOffsetsFactoryBase is
    CarbonOffsetsFactoryStorageV1,
    OwnableUpgradeable,
    PausableUpgradeable,
    UUPSUpgradeable,
    ProjectUtils,
    ...
    AccessControlUpgradeable
{
    ...
    function __CarbonOffsetsFactoryBase_init(
        ...
        whenNotPaused
    {
        ...
        IContractRegistry(contractRegistry).addERC20(
            address(proxyTCO2),
            standardRegistry()
        );
        ...
        returns (bool)
    {
        ...
        address pc = IContractRegistry(tcnRegistry)
            .carbonProjectsAddress();
        address vc = IContractRegistry(tcnRegistry)
