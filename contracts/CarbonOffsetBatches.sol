    ...
    CarbonOffsetBatchesStorage
{
        ...
        initializer
    {
        ...
        __ERC721_init_unchained(
            ' Protocol: Carbon Offset Batches',
            '-COB'
        );
    ...
    function onlyOwningTCO2(uint256 tokenId) internal view {
        ...
        require(
            IContractRegistry(contractRegistry).isValidERC20(tokenOwner),
    ...
    function setContractRegistry(address _address)
        external
        virtual
        onlyOwner
    {
        ...
        whenNotPaused
    {
        ...
        require(
            IContractRegistry(contractRegistry).isValidERC20(
                ownerOf(tokenId)
            ) == false,
        ...
        returns (address)
    {
        ...
        IContractRegistry tcnRegistry = IContractRegistry(
            contractRegistry
        );
        ...
        address tco2Factory = tcnRegistry.CarbonOffsetsFactoryAddress(
            carbonRegistry
        );

        return ICarbonOffsetsFactory(tco2Factory).pvIdtoERC20(pvId);
    }
    ...
    function tokenize(
        ...
        string memory registry = ICarbonOffsets(tco2).standardRegistry();
        require(
